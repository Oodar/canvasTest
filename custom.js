...
(function() {
  var accum, addParticles, elapsedTime, particle, renderable, renderer, rgbaColor, update, vec2d, xPos, yPos,
  ...
  update = function(sceneObjects, sceneRenderer, lastFrameTime) {
    ...
    return setTimeout(update, 1000 / 60, sceneObjects, sceneRenderer, Date.now() / 1000);
  };
